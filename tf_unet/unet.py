...
# usd batch size to be 4
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.75, display_step=1, restore=False, write_graph=False):
        ...
        #yield a warning message in "...99analye in nibabel file"
        #yield assert_equal(message, 'very large origin values relative to dims; leaving as set, ignoring for affine')
        ...
        with tf.Session() as sess:
            ...
            if restore:
                ...
                if ckpt and ckpt.model_checkpoint_path:
                    print ('restore ckpt', ckpt.model_checkpoint_path)
